    ...
    <>
      ...
      <Layout>
        ...
        <div className="w-full flex flex-row gap-8">
              ...
              {data &&
                data.map((item: any) => {
                  return (
                    ...
                    >
                      <div>
                        <h2 className="font-bold text-[1.6rem] text-main-orange">
                          {item.title}
                        </h2>
                        <h3 className="font-semibold text-main-blue">
                          {item.username}, {item.userProfession}
                        </h3>
                      </div>
          ...
          <div className="w-2/5">{showForm ? <ReviewForm /> : ""}</div>
        </div>
      </Layout>
    </>
  );
