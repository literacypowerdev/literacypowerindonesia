...
export default function BenefitCard(props: BenefitCardProps) {
  ...
  return (
    <div className="w-full max-w-[520px] min-h-[150px] sm:min-h-[90px] bg-white shadow-md rounded-[18px] flex items-center justify-center sm:justify-start flex-col sm:flex-row py-4 px-2 sm:px-6 gap-3 sm:gap-6">
